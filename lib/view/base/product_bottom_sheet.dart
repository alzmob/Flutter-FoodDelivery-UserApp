  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: ResponsiveHelper.isMobile(context) ? BorderRadius.vertical(top: Radius.circular(Dimensions.RADIUS_EXTRA_LARGE)) : BorderRadius.all(Radius.circular(Dimensions.RADIUS_EXTRA_LARGE)),
      ),
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              ...
              Row(children: [
                ...
                Text(productController.quantity.toString(), style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                QuantityButton(
            ...
            product.addOns.length > 0 ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              GridView.builder(
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                  crossAxisCount: ResponsiveHelper.isDesktop(context) ? 6 : ResponsiveHelper.isTab(context) ? 5 : 4,
            ...
            (product.scheduleOrder == 0 && !_isAvailable) ? SizedBox() : Row(children: [
              ElevatedButton(
