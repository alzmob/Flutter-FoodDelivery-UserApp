            ...
            Expanded(child: Scrollbar(child: SingleChildScrollView(
              ...
              child: Center(child: SizedBox(width: 1170, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  child: ClipRRect(
                    ...
                    child: Stack(clipBehavior: Clip.none, children: [
                      GoogleMap(
                        ...
                        onTap: (latLng) {
                          Get.toNamed(RouteHelper.getPickMapRoute('add-address'), arguments: PickMapScreen(
                ...
                Center(child: Text(
                  ...
                  style: robotoRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL),
                )),
