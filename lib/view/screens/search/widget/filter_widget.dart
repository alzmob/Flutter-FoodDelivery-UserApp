          ...
          return SingleChildScrollView(
            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Text('filter'.tr, style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                CustomButton(
                  onPressed: () {
              ...
              Text('sort_by'.tr, style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
              ...
              Text('filter_by'.tr, style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
              SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
              CustomCheckBox(
              ...
              isRestaurant ? SizedBox() : Column(children: [
                Text('price'.tr, style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                RangeSlider(
              ...
              Text('rating'.tr, style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
              Container(
