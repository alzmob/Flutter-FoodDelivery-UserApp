        ...
        body: SafeArea(child: Padding(
          ...
          child: GetBuilder<SearchController>(builder: (searchController) {
            ...
            return Column(children: [
              ...
              Center(child: SizedBox(width: 1170, child: Row(children: [
              ...
              Expanded(child: searchController.isSearchMode ? SingleChildScrollView(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  searchController.historyList.length > 0 ? Center(child: SizedBox(width: 1170, child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Text('history'.tr, style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                    InkWell(
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Center(child: SizedBox(width: 1170, child: Column(children: [
                        Row(children: [
                          Expanded(
                            child: InkWell(
                  ...
                  (_isLoggedIn && searchController.suggestedFoodList != null) ? Text(
                    'suggestions'.tr, style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE),
                  ) : SizedBox(),
