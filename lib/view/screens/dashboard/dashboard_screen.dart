  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        floatingActionButton: GetPlatform.isDesktop ? null : FloatingActionButton(
          elevation: 5,
        ...
        floatingActionButtonLocation: GetPlatform.isDesktop ? null : FloatingActionButtonLocation.centerDocked,
