...
class AccessLocationScreen extends StatelessWidget {
  ...
  final bool fromHome;
  AccessLocationScreen({@required this.fromSignUp, @required this.fromHome});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: GetPlatform.isDesktop ? null : CustomAppBar(title: 'set_location'.tr, isBackButtonExist: fromHome),
      body: SafeArea(child: Padding(
        ...
        child: GetBuilder<LocationController>(builder: (locationController) {
          return _isLoggedIn ? Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            locationController.addressList != null ? locationController.addressList.length > 0 ? Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Center(child: SizedBox(width: 1170, child: AddressWidget(
                    address: locationController.addressList[index],
                    fromAddress: false,
                    onTap: () {
                      Get.dialog(CustomLoader(), barrierDismissible: false);
                      AddressModel _address = locationController.addressList[index];
                      locationController.saveAddressAndNavigate(_address, fromSignUp);
                    },
                  )));
                },
              ),
            ...
            BottomButton(locationController: locationController, fromSignUp: fromSignUp),
...
class BottomButton extends StatelessWidget {
  ...
  final bool fromSignUp;
  BottomButton({@required this.locationController, @required this.fromSignUp});
    ...
    return Column(children: [
        ...
        onPressed: () async {
          _checkPermission(() async {
            ...
            if(_response.isSuccess) {
              ...
              Get.back();
              Get.toNamed(RouteHelper.getPickMapRoute(RouteHelper.accessLocation));
      ...
      TextButton(
        style: TextButton.styleFrom(
          ...
          minimumSize: Size(1170, 50),
          padding: EdgeInsets.zero,
        ),
        onPressed: () => Get.toNamed(RouteHelper.getPickMapRoute(fromSignUp ? RouteHelper.signUp : RouteHelper.accessLocation)),
