...
class PickMapScreen extends StatelessWidget {
  ...
  PickMapScreen({@required this.fromSignUp, @required this.fromAddAddress, this.googleMapController});
  ...
  void _openSearchDialog(BuildContext context, GoogleMapController mapController) async {
    ...
    Get.find<LocationController>().setLocation(prediction.placeId, prediction.description, AppConstants.MAP_API_KEY, mapController);
  }
