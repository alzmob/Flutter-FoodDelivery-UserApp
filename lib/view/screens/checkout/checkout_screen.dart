        ...
        return GetBuilder<CouponController>(builder: (couponController) {
          return GetBuilder<OrderController>(builder: (orderController) {
            ...
            if(orderController.distance != null) {
              ...
              if(orderController.orderType == 'take_away' || restController.restaurant.freeDelivery == 1) {
                _deliveryCharge = 0;
              }
            }
                    ...
                    child: Center(child: SizedBox(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        restController.restaurant.delivery ? DeliveryOptionButton(
                          value: 'delivery', title: 'home_delivery'.tr, charge: _charge, isFree: restController.restaurant.freeDelivery == 1,
                        ) : SizedBox(),
                        ...
                        // Time Slot
                        restController.restaurant.scheduleOrder == 1 ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              Expanded(
                                child: Container(
                                  decoration: BoxDecoration(boxShadow: [BoxShadow(
                                    color: Colors.grey[Get.isDarkMode ? 800 : 200], spreadRadius: 1, blurRadius: 5,
                                  )]),
                                  child: TextField(
                ...
                Container(
                  ...
                  child: !orderController.isLoading ? CustomButton(buttonText: 'confirm_order'.tr, onPressed: () {
                    ...
                    if(orderController.timeSlots == null || orderController.timeSlots.length == 0) {
                      ...
                      for (CartModel cart in _cartList) {
                        if (!DateConverter.isAvailable(
                          ...
                          time: restController.restaurant.scheduleOrder == 1 ? _scheduleDate : null,
                        )) {
                          _isAvailable = false;
                          break;
                        }
                    ...
                    if(_orderAmount < restController.restaurant.minimumOrder) {
                      ...
                      if(restController.restaurant.scheduleOrder == 1) {
                      ...
                      orderController.placeOrder(PlaceOrderBody(
                        ...
                        scheduleAt: restController.restaurant.scheduleOrder == 0 ? null : (orderController.selectedDateSlot == 0
      ...
      if(_isCashOnDeliveryActive && Get.find<OrderController>().paymentMethodIndex == 0) {
       ...
       if(GetPlatform.isWeb) {
         ...
         String selectedUrl = '${AppConstants.BASE_URL}/payment-mobile?order_id=$orderID&&customer_id=${Get.find<UserController>()
             .userInfoModel.id}&&callback=http://$hostname${RouteHelper.orderSuccess}?id=$orderID&status=';
