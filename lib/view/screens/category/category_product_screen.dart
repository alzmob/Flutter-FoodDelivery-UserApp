        ...
        child: Scaffold(
          ...
          body: Scrollbar(child: SingleChildScrollView(controller: scrollController, child: Center(child: SizedBox(
            ...
            child: Column(children: [
              ...
              _products != null ? _products.length > 0 ? GridView.builder(
                ...
                itemBuilder: (context, index) {
                  return ProductWidget(
                    product: _products[index], isRestaurant: false, restaurant: null,
                    hasDivider: index != _products.length-1,
                  );
                },
              ) : NoDataScreen(text: 'no_category_product_found'.tr) : GridView.builder(
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                  crossAxisSpacing: 10,
                  childAspectRatio: 4,
                  crossAxisCount: ResponsiveHelper.isDesktop(context) ? 3 : ResponsiveHelper.isTab(context) ? 2 : 1,
                ...
                shrinkWrap: true,
                itemBuilder: (context, index) {
                  return ProductShimmer(isEnabled: _products == null, isRestaurant: false);
                },
              ),
