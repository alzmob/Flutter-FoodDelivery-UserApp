  ...
  Widget build(BuildContext context) {
    return GetBuilder<ProductController>(builder: (productController) {
      return Scrollbar(child: SingleChildScrollView(
        ...
        child: Center(child: SizedBox(width: 1170, child: ListView.builder(
            ...
            return Container(
              ...
              child: Column(children: [
                ...
                Row(
                  children: [
                    ClipRRect(
                      ...
                      child: CustomImage(
                        ...
                        image: '${Get.find<SplashController>().configModel.baseUrls.productImageUrl}'
                            '/${orderDetailsList[index].foodDetails.image}',
                      ),
                    ),
                    ...
                    Expanded(child: Column(
                      ...
                      children: [
                        Text(orderDetailsList[index].foodDetails.name, style: robotoMedium, maxLines: 2, overflow: TextOverflow.ellipsis),
                        SizedBox(height: 10),
                        Text(PriceConverter.convertPrice(orderDetailsList[index].foodDetails.price), style: robotoBold),
                      ],
                    )),
                    Row(children: [
                      Text(
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      !productController.loadingList[index] ? CustomButton(
                          ...
                          if(!productController.submitList[index]) {
                            if (productController.ratingList[index] == 0) {
                              ...
                              ReviewBody reviewBody = ReviewBody(
                                productId: orderDetailsList[index].foodDetails.id.toString(),
