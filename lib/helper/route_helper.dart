...
class RouteHelper {
  ...
  static String getPickMapRoute(String page) => '$pickMap?page=$page';
  ...
  static String getMapRoute(String address, String type, String lat, String long, String name, String num, int id, int user, String page) {
    return '$map?address=$address&type=$type&lat=$lat&long=$long&name=$name&num=$num&id=$id&user=$user&page=$page';
  }
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: accessLocation, page: () => AccessLocationScreen(fromSignUp: Get.parameters['page'] == signUp, fromHome: Get.parameters['page'] == 'home')),
    GetPage(name: pickMap, page: () {
      ...
      return (_fromAddress && _pickMapScreen == null) ? NotFound() : _pickMapScreen != null ? _pickMapScreen
          : PickMapScreen(fromSignUp: Get.parameters['page'] == signUp, fromAddAddress: _fromAddress);
    }),
    ...
    GetPage(name: orderDetails, page: () {
      return getRoute(Get.arguments != null ? Get.arguments : OrderDetailsScreen(orderId: int.parse(Get.parameters['id']), orderModel: null));
    }),
    ...
    GetPage(name: map, page: () {
      return getRoute(MapScreen(fromRestaurant: Get.parameters['page'] == 'restaurant', address: AddressModel(
        id: int.parse(Get.parameters['id']), userId: int.parse(Get.parameters['user']), address: Get.parameters['address'],
        contactPersonName: Get.parameters['name'], contactPersonNumber: Get.parameters['num'],
        latitude: Get.parameters['lat'], longitude: Get.parameters['long'], addressType: Get.parameters['type'],
      )));
    }),
    ...
    GetPage(name: categoryProduct, page: () {
      List<int> _decode = base64Decode(Get.parameters['name']);
      String _data = utf8.decode(_decode);
  ...
  static getRoute(Widget navigateTo) {
    return AppConstants.APP_VERSION < Get.find<SplashController>().configModel.appMinimumVersion ? UpdateScreen()
        : Get.find<LocationController>().getUserAddress() != null ? navigateTo : AccessLocationScreen(fromSignUp: false, fromHome: false);
  }
}